...
1. **https://agentskills.io/llms.txt** — the public docs index for skills. Good to fetch when creating, reviewing, validating, or auditing a skill if you want to check the official rules.
