...
description: Runs an ultra review of the proposed tickets in a pull request for clarity, implementability, and ticket-author compliance, optionally posting findings as PR comments. Use only when the user explicitly asks to lint or ultra-review the tickets (not the code) in a PR — for example ticket-ultra-review this PR, ultra-review the tickets, or review the proposed tickets in a PR. Do NOT use for code review, for general review-this-PR requests, or when a PR is merely mentioned.
---
