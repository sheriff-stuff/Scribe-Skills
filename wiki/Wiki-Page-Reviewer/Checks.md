...
- **Template** — required scaffolding from the [page template](../../skills/wiki-page-author/assets/page-template) is present and all placeholders are filled in. Optional pieces are not flagged when legitimately omitted.
