...
- New `> [!ODD]` blocks use the [Open Design Decision template](../../.claude/skills/wiki-page-author/assets/odd-template.md).
- New `> [!CAUTION]` blocks use the [Page Investigation Caution template](../../.claude/skills/wiki-page-author/assets/caution-template.md).
