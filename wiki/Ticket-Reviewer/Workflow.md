...
3. For every ticket type encountered in the batch, read its matching template from [`plugins/ticket-author/skills/ticket-author/assets/`](../../plugins/ticket-author/skills/ticket-author/assets/).
